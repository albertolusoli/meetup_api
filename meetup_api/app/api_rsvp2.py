...
if __name__=="__main__":
        urlname = 'non-technical-entrepreneurs-vancouver'
        event_id = 'zgphdpyxfbzb'


        main(urlname, event_id, 4 , 'tech')
